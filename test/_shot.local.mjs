...
const htmlSrc = fs.readFileSync("public/index.html");
const server = http.createServer((req, res) => { res.writeHead(200, { "content-type": "text/html" }); res.end(htmlSrc); });
...
const file = "http://localhost:" + port + "/";
...
for (const [scheme, width, name] of [["light", 1280, "light"], ["dark", 1280, "dark"], ["light", 390, "mobile"]]) {
  ...
  await page.screenshot({ path: `C:/Users/alexa/AppData/Local/Temp/claude/C--Users-alexa-OneDrive-Documentos-dashboard-missao-bahia/c0b5012b-6e38-4cf3-82c4-e1b390c138ed/scratchpad/${name}.png`, fullPage: true });
